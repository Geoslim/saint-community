            ...
            @include('includes.messages')
                <div class="form__header--list">
                    ...
                    <div class="form__container">
                        ...
                        <form method="POST" action="{{action('BranchesController@store')}}">
                            <div class="geo" style="padding:10px 100px;">
                                <input type="text" class="" id="location" name="location" placeholder="Location" value="">
                                <textarea id="address" name="address" cols="" rows="10"></textarea>
                            </div>
                            @csrf
