                       ...
                       <table class="table__container--main" >
                           ...
                           <tbody>
                                <tr class="table__row">
                                    ...
                                    <td class="table__data">Media Body</td>
                                    <td class="table__data">
                                        <a href="{{ url('media-body') }}" alt="Edit" title="Edit" style="color: #000; text-decoration: none;">
                                            Edit
                                        </a>  
                                    </td>
                                </tr>
                                <tr class="table__row">
                                    ...
                                    <td class="table__data">Media Publish</td>
                                    <td class="table__data">
                                        <a href="{{ url('media-publish') }}" alt="Edit" title="Edit" style="color: #000; text-decoration: none;">
                                            Edit
                                        </a>  
                                    </td>
                                </tr>
