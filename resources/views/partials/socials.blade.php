<div class="home_social_wrapper main_row">
    ...
    <div class="home_flex_container">
        ...
        <div class="home_social__link_container">
            <a href="https://mobile.twitter.com/<?php echo $socialmedia->twitter; ?>" target="_blank" class="home_social__link">
        ...
        <div class="home_social__link_container">
            <a href="https://web.facebook.com/<?php echo $socialmedia->facebook; ?>/" class="home_social__link" target="_blank">
                <img src="resources/images/follow_facebook(1).png" class="home_social__img" alt="">
            </a>
        </div>
        <div class="home_social__link_container">
            <a href="https://www.youtube.com/channel/<?php echo $socialmedia->youtube; ?>" target="_blank" class="home_social__link">
                <img src="resources/images/YouTube.png" class="home_social__img" alt="">
            </a>
        </div>
        <div class="home_social__link_container">
            <a href="https://www.instagram.com/<?php echo $socialmedia->instagram; ?>/" target="_blank" class="home_social__link">
